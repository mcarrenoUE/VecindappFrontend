...
@Component({
  selector: 'app-registrodostrabajador',
  templateUrl: './registrodostrabajador.component.html',
  styleUrl: './registrodostrabajador.component.css'
})
export class RegistrodostrabajadorComponent {
